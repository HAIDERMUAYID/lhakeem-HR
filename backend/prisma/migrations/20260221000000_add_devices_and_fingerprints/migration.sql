...
-- AddForeignKey
ALTER TABLE "employee_fingerprints" ADD CONSTRAINT "employee_fingerprints_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
